...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in github.com/containerd/containerd/api/services/streaming/v1/streaming_pb2_grpc.py depends on'
...
def add_StreamingServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'containerd.services.streaming.v1.Streaming', rpc_method_handlers)
